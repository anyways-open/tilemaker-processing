...
function way_function(way)
	...
	local isArea = isClosed and way.Find("area") == "yes"
	...
	if highway~="" then
		...
		if minzoom <= 14 then
			...
			way:Attribute("cycleway:lane", cycleway_lane)
			way:Attribute("cycleway:left", cycleway_left)
			way:Attribute("cycleway:right", cycleway_right)
